...
FILE_LIST=(concurrent.sh copy.sh diff_continuous.sh diff.sh huge-tickets.sh image_read.sh import_export.sh journal.sh kernel.sh map-snapshot-io.sh map-unmap.sh merge_diff.sh notify_master.sh notify_slave.sh permissions.sh qemu_dynamic_features.sh qemu-iotests.sh qemu_rebuild_object_map.sh rbd_mirror_helpers.sh rbd_mirror.sh rbd_mirror_stress.sh rbd-nbd.sh read-flags.sh run_cli_tests.sh set_ro.py simple_big.sh smalliobench.sh test_admin_socket.sh test_librbd_api.sh test_librbd_python.sh test_librbd.sh test_lock_fence.sh test_rbdmap_RBDMAPFILE.sh test_rbd_mirror.sh verify_pool.sh)
