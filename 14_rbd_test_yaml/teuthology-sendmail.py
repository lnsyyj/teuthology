...
if __name__ == '__main__':
	...
	rbd_job_list = ["cli_generic", "diff_continuous", "diff", "import_export", "issue-20295", "journal", "notify_master", "notify_slave", "permissions", "qemu-iotests", "rbd_groups", "read-flags", "test_librbd_api", "test_librbd_python", "test_librbd", "test_lock_fence", "test_rbd_mirror", "verify_pool"]
