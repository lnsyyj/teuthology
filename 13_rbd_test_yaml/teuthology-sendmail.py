...
if __name__ == '__main__':
	...
	paddles_fs_url = "http://10.121.8.93:8080/runs/" + data_time + "-3.0-FS"
	...
	fs_test_log_url = "http://10.121.8.93/" + data_time + "-3.0-FS"
	...
	fs_result_items = get_teuthology_result(paddles_fs_url, fs_test_log_url)

	teuthology_result_items = rbd_result_items + rados_result_items + ceph_test_result_items + fs_result_items
	rbd_job_list = ["cli_generic", "diff_continuous", "diff", "import_export", "issue-20295", "journal", "notify_master", "notify_slave", "rbd_groups", "read-flags", "test_librbd_api", "test_librbd_python", "test_librbd", "test_lock_fence", "verify_pool"]
	rados_job_list = ["load-gen-big", "load-gen-mix", "load-gen-mix-small-long", "load-gen-mix-small", "load-gen-mostlyread", "stress_watch", "test_cache_pool", "test_pool_access", "test_pool_quota", "test_rados_tool", "test_tmap_to_omap"]
	ceph_test_job_list = ["ceph_test_async_driver", "ceph_test_async_networkstack", "ceph_test_cls_hello", "ceph_test_cls_journal", "ceph_test_cls_lock", "ceph_test_cls_log", "ceph_test_cls_numops", "ceph_test_cls_rbd", "ceph_test_cls_refcount", "ceph_test_cls_rgw", "ceph_test_filejournal", "ceph_test_keyvaluedb", "ceph_test_libcephfs", "ceph_test_libcephfs_access", "ceph_test_msgr", "ceph_test_rados_api_aio", "ceph_test_rados_api_asio", "ceph_test_rados_api_cmd", "ceph_test_rados_api_c_read_operations", "ceph_test_rados_api_c_write_operations", "ceph_test_rados_api_io", "ceph_test_rados_api_list", "ceph_test_rados_api_lock", "ceph_test_rados_api_misc", "ceph_test_rados_api_pool", "ceph_test_rados_api_service", "ceph_test_rados_api_snapshots", "ceph_test_rados_api_stat", "ceph_test_rados_api_tier", "ceph_test_rados_api_watch_notify", "ceph_test_rados_delete_pools_parallel", "ceph_test_rados_list_parallel", "ceph_test_rados_open_pools_parallel", "ceph_test_rados_striper_api_aio", "ceph_test_rados_striper_api_io", "ceph_test_rados_striper_api_striping", "ceph_test_rados_watch_notify", "ceph_test_rbd_mirror", "ceph_test_stress_watch"]
	fs_job_list = ["direct_io", "dirfrag", "filelock_deadlock", "filelock_interrupt", "i_complete_vs_rename", "mkpool_layout_vxattrs", "rstats", "trivial_sync", "xattrs", "quota", "snap-rm-diff", "snaptest-1", "snaptest-2", "snaptest-authwb", "snaptest-capwb", "snaptest-dir-rename", "snaptest-double-null", "snaptest-estale", "snaptest-git-ceph", "snaptest-hardlink", "snaptest-intodir", "snaptest-multiple-capsnaps", "snaptest-parents", "snaptest-realm-split", "snaptest-snap-rename", "snaptest-snap-rm-cmp", "snaptest-upchildrealms", "snaptest-xattrwb"]
	...
	fs_result_report_items = get_teuthology_report_result(paddles_fs_url, fs_job_list)
	teuthology_result_report_items = rbd_result_report_items + rados_result_report_items + ceph_test_result_report_items + fs_result_report_items
	...
	email_results(subject="[Teuthology]  ThinkCloud-SDS-3.0.0-daily Test Report", from_="yujiang2@lenovo.com", to="yujiang2@lenovo.com,sunlei5@lenovo.com,zhangzz6@lenovo.com,zhangyil@lenovo.com,zhouyf6@lenovo.com,houtf1@lenovo.com,renyb2@lenovo.com,magf@lenovo.com,cloudtester2@lenovo.com,houmx1@lenovo.com,xuhe4@lenovo.com,xiegang2@lenovo.com,wugang3@lenovo.com,liujun8@lenovo.com,cuixf1@lenovo.com,lihong5@lenovo.com,sunxw3@lenovo.com,wangqh8@lenovo.com,yuwj1@lenovo.com,yangjn1@lenovo.com,wangquan6@lenovo.com,jiasm2@lenovo.com,chengjx1@lenovo.com,haozm1@lenovo.com,wenlj1@lenovo.com", body=email_body)
