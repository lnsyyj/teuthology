...
if __name__ == '__main__':
	...
	rbd_job_list = ["cli_generic.sh", "diff_continuous.sh", "diff.sh", "import_export.sh", "issue-20295.sh", "journal.sh", "notify_master.sh", "notify_slave.sh", "rbd_groups.sh", "read-flags.sh", "test_librbd_api.sh", "test_librbd_python.sh", "test_librbd.sh", "test_lock_fence.sh", "verify_pool.sh"]
	rados_job_list = ["load-gen-big", "load-gen-mix", "load-gen-mix-small-long", "load-gen-mix-small", "load-gen-mostlyread", "test_cache_pool", "test_pool_access", "test_pool_quota", "test_python", "test_rados_timeouts", "test_rados_tool", "test_tmap_to_omap"]
