...
MACHINE_LIST=(teuthology-sds-controller plana003 plana004 plana005 plana006)
...
function rebuild_virtual_machine() {
    ...
    openstack server rebuild plana003 --image 2019-07-18-plana003-snap --password ${MACHINE_PASSWORD}
    openstack server rebuild plana004 --image 2019-07-18-plana004-snap --password ${MACHINE_PASSWORD}
    openstack server rebuild plana005 --image 2019-07-18-plana005-snap --password ${MACHINE_PASSWORD}
    openstack server rebuild plana006 --image 2019-07-18-plana006-snap --password ${MACHINE_PASSWORD}
}
