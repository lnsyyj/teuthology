...
FILE_LIST=(copy.sh.yaml diff.sh.yaml image_read.sh.yaml import_export.sh.yaml journal.sh.yaml kernel.sh.yaml map-snapshot-io.sh.yaml map-unmap.sh.yaml merge_diff.sh.yaml permissions.sh.yaml qemu_dynamic_features.sh.yaml qemu-iotests.sh.yaml qemu_rebuild_object_map.sh.yaml rbd_mirror_helpers.sh.yaml rbd_mirror.sh.yaml rbd_mirror_stress.sh.yaml rbd-nbd.sh.yaml read-flags.sh.yaml run_cli_tests.sh.yaml set_ro.py.yaml simple_big.sh.yaml smalliobench.sh.yaml test_admin_socket.sh.yaml test_librbd_python.sh.yaml test_librbd.sh.yaml test_rbdmap_RBDMAPFILE.sh.yaml test_rbd_mirror.sh.yaml verify_pool.sh.yaml diff_continuous.sh.yaml test_librbd_api.sh.yaml concurrent.sh.yaml notify_master.sh.yaml)
