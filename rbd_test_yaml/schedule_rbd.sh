...
FILE_LIST=(copy.sh.yaml diff.sh.yaml import_export.sh.yaml journal.sh.yaml permissions.sh.yaml qemu-iotests.sh.yaml read-flags.sh.yaml run_cli_tests.sh.yaml smalliobench.sh.yaml test_admin_socket.sh.yaml test_librbd_python.sh.yaml test_librbd.sh.yaml test_rbdmap_RBDMAPFILE.sh.yaml test_rbd_mirror.sh.yaml verify_pool.sh.yaml diff_continuous.sh.yaml test_librbd_api.sh.yaml notify_master.sh.yaml test_lock_fence.sh.yaml notify_slave.sh.yaml merge_diff.sh.yaml)
