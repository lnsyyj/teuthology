...
if __name__ == '__main__':
	...
	rbd_job_list = ["copy", "diff", "import_export", "journal", "permissions", "read-flags", "run_cli_tests", "smalliobench", "test_admin_socket", "test_librbd_python", "test_librbd", "test_rbdmap_RBDMAPFILE", "test_rbd_mirror", "verify_pool", "diff_continuous", "test_librbd_api", "notify_master", "test_lock_fence", "notify_slave", "merge_diff"]
	rados_job_list = ["load-gen-big", "load-gen-mix", "load-gen-mix-small-long", "load-gen-mix-small", "load-gen-mostlyread", "stress_watch", "test_cache_pool", "test_pool_quota", "test_python", "test_rados_timeouts", "test_rados_tool", "test_tmap_to_omap"]
