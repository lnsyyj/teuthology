...
if __name__ == '__main__':
	...
	rbd_job_list = ["copy", "diff", "import_export", "journal", "permissions", "qemu-iotests", "read-flags", "run_cli_tests", "smalliobench", "test_admin_socket", "test_librbd_python", "test_librbd", "test_rbdmap_RBDMAPFILE", "test_rbd_mirror", "verify_pool", "diff_continuous", "test_librbd_api", "notify_master", "test_lock_fence", "notify_slave", "merge_diff"]
