...
COPY_SDS_DEPLOY_SHELL_NODE="192.168.0.65"
COPY_SSH_RSA_PUB_NODE=(192.168.0.65 192.168.0.60 192.168.0.61 192.168.0.62 192.168.0.63)
TEUTHOLOGY_INSTALL_RPM_CEPH_NODE=(192.168.0.60 192.168.0.61 192.168.0.62 192.168.0.63)
CRUSHMAP_CEPH_NODE="192.168.0.60"
TEUTHOLOGY_NODE="192.168.0.14"

COPY_LICENSE_FILE_NAME="ThinkCloud_Storage_license_trial_2018-12-03.zip"
COPY_SDS_DEPLOY_SHELL_NAME="teuthology-deploy-sds-ceph13.sh"
...
CEPH_RPMS=()
CEPH_SOURCE_PACKAGE="ceph-13.2.4.tar.gz"
...
function remote_teuthology_add_schedule() {
        ssh "root@${TEUTHOLOGY_NODE}" "/home/teuthology/src/teuthology_master/13_fs_test_yaml/schedule_fs.sh"
	ssh "root@${TEUTHOLOGY_NODE}" "/home/teuthology/src/teuthology_master/13_rados_test_yaml/schedule_rados.sh"
	ssh "root@${TEUTHOLOGY_NODE}" "/home/teuthology/src/teuthology_master/13_rbd_test_yaml/schedule_rbd.sh"
        ssh "root@${TEUTHOLOGY_NODE}" "/home/teuthology/src/teuthology_master/13_ceph_test_rpm_yaml/schedule_ceph_test.sh"
}
